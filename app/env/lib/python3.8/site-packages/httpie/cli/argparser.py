...
from httpie.cli.argtypes import (PARSED_DEFAULT_FORMAT_OPTIONS,
                                 AuthCredentials, KeyValueArgType, parse_auth,
                                 parse_format_options)
from httpie.cli.constants import (HTTP_GET, HTTP_POST, OUT_RESP_BODY,
...
class HTTPieArgumentParser(argparse.ArgumentParser):
    ...
    def _guess_method(self):
        ...
        # FIXME: False positive, e.g., "localhost" matches but is a valid URL.
            ...
            try:
                ...
                # Infer the method
                has_data = self.has_stdin_data or any(
    ...
    def _process_output_options(self):
        ...
        def check_options(value, option):
            ...
            if unknown:
                self.error(
                    "Unknown output options: {0}={1}".format(option, ",".join(unknown))
                )
